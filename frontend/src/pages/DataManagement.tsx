...
import GrowthMetricManager from "../components/GrowthMetricManager";
...
type Tab = "projects" | "participants" | "grants" | "expenses" | "programs" | "growth" | "partners" | "surveys" | "import" | "audit";

const TABS: { key: Tab; label: string }[] = [
  { key: "projects", label: "프로젝트 관리" },
  { key: "grants", label: "장학금(지원금) 내역" },
  { key: "expenses", label: "기타 지급(심사·운영비)" },
  { key: "programs", label: "세부 프로그램 관리" },
  { key: "growth", label: "성장관리 성과" },
...
export default function DataManagement() {
  ...
  return (
    <div>
      ...
      {tab === "growth" && <GrowthMetricManager ctx={ctx} />}
